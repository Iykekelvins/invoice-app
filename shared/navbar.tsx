...
export default function Navbar() {
	...
	return (
		<nav
			className='flex items-center justify-between min-[781px]:hidden sticky top-0
    bg-sidebar z-10
    '>
			<Link href='/' aria-label='Home page'>
				<Image src='/favicon.png' width={80} height={80} alt='app logo' />
			</Link>
			...
			<div className='flex items-center gap-8 mr-6 self-stretch'>
				...
				<span className='bg-[#494E6E] w-px h-full' />
